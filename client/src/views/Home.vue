...
<template>
  <div class="home">
    ...
    <Panel header="设置">
      <div class="pb15">
        <div class="pb10">头像URL：<Avatar shape="circle" :image="avatarPre" v-if="avatarPre" /></div>
        
        <div><InputText class="input-text-full" @blur="changeAvatar" placeholder="设置头像URL" v-model="avatar"/></div>
      </div>
      <div class="pb15">
      ...
      <div v-show="isSpeech">
        <div class="pb15">
          <div class="pb10">提供商：</div>
          <div><SelectButton v-model="cloudSel" :options="cloudList" optionLabel="name" optionValue="value" /></div>
        </div>
        <div class="pb15">
        ...
        <div class="pb15">
          ...
          <div><InputText class="input-text-full" v-model="AccessToken"/></div>
        </div>
        <div class="pb15">
          <div class="pb10">声源（参考<a href="https://help.aliyun.com/document_detail/84435.htm?spm=a2c4g.11186623.2.22.28cf4a9c70HlT2#topic-2572243" target="_blank">阿里云文档</a>）：</div>
...
export default {
  ...
  methods: {
    saveSetting(){
      ...
      this.$toast.add({severity:'success', summary: '发送成功', detail:'发送成功', life: 3000});
    ...
    init() {
      ...
      if(settingDataStr){
        ...
        this.cloudSel = settingData.cloudSel || "aliyun"
